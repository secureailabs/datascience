...
T = TypeVar("T", bound="BodyStatisticsSpearman")


@attr.s(auto_attribs=True)
class BodyStatisticsSpearman:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_statistics_spearman = cls(
            series_1_id=series_1_id,
            series_2_id=series_2_id,
            alternative=alternative,
        )

        body_statistics_spearman.additional_properties = d
        return body_statistics_spearman
