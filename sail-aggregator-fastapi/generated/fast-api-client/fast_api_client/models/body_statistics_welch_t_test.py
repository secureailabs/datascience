...
T = TypeVar("T", bound="BodyStatisticsWelchTTest")


@attr.s(auto_attribs=True)
class BodyStatisticsWelchTTest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_statistics_welch_t_test = cls(
            series_1_id=series_1_id,
            series_2_id=series_2_id,
            alternative=alternative,
        )

        body_statistics_welch_t_test.additional_properties = d
        return body_statistics_welch_t_test
