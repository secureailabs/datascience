...
T = TypeVar("T", bound="BodyStatisticsWilcoxonSignedRankTest")


@attr.s(auto_attribs=True)
class BodyStatisticsWilcoxonSignedRankTest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_statistics_wilcoxon_signed_rank_test = cls(
            series_1_id=series_1_id,
            series_2_id=series_2_id,
            alternative=alternative,
        )

        body_statistics_wilcoxon_signed_rank_test.additional_properties = d
        return body_statistics_wilcoxon_signed_rank_test
