...
T = TypeVar("T", bound="BodyStatisticsKolmogorovSmirnovTest")


@attr.s(auto_attribs=True)
class BodyStatisticsKolmogorovSmirnovTest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_statistics_kolmogorov_smirnov_test = cls(
            series_1_id=series_1_id,
            type_distribution=type_distribution,
        )

        body_statistics_kolmogorov_smirnov_test.additional_properties = d
        return body_statistics_kolmogorov_smirnov_test
