...
T = TypeVar("T", bound="BodyStatisticsPearson")


@attr.s(auto_attribs=True)
class BodyStatisticsPearson:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_statistics_pearson = cls(
            series_1_id=series_1_id,
            series_2_id=series_2_id,
            alternative=alternative,
        )

        body_statistics_pearson.additional_properties = d
        return body_statistics_pearson
