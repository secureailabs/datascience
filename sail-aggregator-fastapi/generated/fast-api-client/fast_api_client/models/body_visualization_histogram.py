...
T = TypeVar("T", bound="BodyVisualizationHistogram")


@attr.s(auto_attribs=True)
class BodyVisualizationHistogram:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_visualization_histogram = cls(
            series_1_id=series_1_id,
            bin_count=bin_count,
        )

        body_visualization_histogram.additional_properties = d
        return body_visualization_histogram
