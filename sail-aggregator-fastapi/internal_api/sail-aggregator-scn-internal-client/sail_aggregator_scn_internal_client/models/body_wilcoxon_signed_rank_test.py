...
T = TypeVar("T", bound="BodyWilcoxonSignedRankTest")


@attr.s(auto_attribs=True)
class BodyWilcoxonSignedRankTest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        body_wilcoxon_signed_rank_test = cls(
            series_1_id=series_1_id,
            series_2_id=series_2_id,
            alternative=alternative,
        )

        body_wilcoxon_signed_rank_test.additional_properties = d
        return body_wilcoxon_signed_rank_test
