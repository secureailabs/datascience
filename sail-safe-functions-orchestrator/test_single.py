...
packager_data_federation.prepare_data_federation(path_file_data_federation_packaged)
print("getting list")
sys.stdout.flush()
dict_dataset_name_to_dataset_id = packager_data_federation.get_dict_dataset_name_to_dataset_id(
    path_file_data_federation_packaged
)
dataset_logitudinal_id = dict_dataset_name_to_dataset_id[dataset_logitudinal_name]
print("done list")
sys.stdout.flush()

# here starts platform code
dataset_longitudinal = serializar_fhirv1.read_dataset(dataset_logitudinal_id)
...
# act
serializar_csvv1.write_dataset(dataset_tabular)
dataset_tabular_reloaded = serializar_csvv1.read_dataset(dataset_tabular.dataset_id)
