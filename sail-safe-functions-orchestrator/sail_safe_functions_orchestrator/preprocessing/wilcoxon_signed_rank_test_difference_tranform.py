...
def wilcoxon_signed_rank_test_difference_tranform(
    sample_0: SeriesFederated, sample_1: SeriesFederated
) -> Tuple[List[float], List[float]]:
    return WilcoxonSignedRankTestDifferenceTranform.run(sample_0, sample_1)


class WilcoxonSignedRankTestDifferenceTranform:
    "Tranform for Wilcoxon Signed Rank Test"
