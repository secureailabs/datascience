...
from sail_safe_functions_orchestrator.data_model_longitudinal import \
...
class DatasetLongitudinalFederatedLocal(DatasetLongitudinalFederated):
    ...
    def add_data_frame_longitudinal(self, id_dataset: str, data_frame_longitudinal: ReferenceDatasetLongitudinal):
