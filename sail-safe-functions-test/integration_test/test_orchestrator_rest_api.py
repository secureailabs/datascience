...
async def data_model_frame(data_frame_name: str) -> dict:
    ...
    return {"dataframe_id": dataframe_id}


@app.post("/data_model_frame/{data_model_id}/model_series")
async def data_model_add_series(data_model_id: str, series_name: str, source_name: str) -> dict:
...
@app.post("/data_frame_tabular/{data_frame_tabular_id}/{data_model_id}")
async def data_frame_add_data_model(data_frame_tabular_id: str, data_model_id: str) -> dict:
    data_model_tabular = service_reference.get_instance().reference_to_data_model_tabular(data_frame_tabular_id)
    data_model = service_reference.get_instance().reference_to_data_model_data_frame(data_model_id)
