...
def test_drop_series_with_missing(data_frame_federated_kidney_hasnan: DataFrameFederated):
    ...
    # Act
    data_frame_federated_kidney_fixed = preprocessing.drop_series_with_missing(
        data_frame_federated_kidney_hasnan, how="any", thresh=None, subset=None
    )
    ...
    # Assert
    assert data_frame_kidney_direct.shape == list(data_frame_kidney_fixed.dict_dataframe.values())[0].shape
