...
@pytest.mark.active
def test_age_happy(data_frame_federated_kidney: DataFrameFederated):
    ...
    data_frame_federated_kidney_fixed = preprocessing.impute_constant(
        data_frame_federated_kidney, list_name_column=["age"], missing_value=0
    )
...
def test_age_exception(data_frame_federated_kidney: DataFrameFederated):
    ...
    with pytest.raises(ValueError, match="missing_value is string type but column with name age is not"):
        preprocessing.impute_constant(
            data_frame_federated_kidney, list_name_column=["age"], missing_value="stringvalue"
        )
...
@pytest.mark.active
def test_rbc_happy(data_frame_federated_kidney: DataFrameFederated):
    ...
    # Act
    data_frame_federated_kidney_fixed = preprocessing.impute_constant(
        data_frame_federated_kidney, list_name_column=["rbc"], missing_value="normal"
    )
    data_frame_kidney_fixed = list(data_frame_federated_kidney_fixed.dict_dataframe.values())[0]
    data_frame_kidney = list(data_frame_federated_kidney.dict_dataframe.values())[0]
    # Assert
...
def test_rbc_exception(data_frame_federated_kidney: DataFrameFederated):
    ...
    with pytest.raises(ValueError, match="missing_value is numeric type but column with name rbc is not"):
        preprocessing.impute_constant(data_frame_federated_kidney, list_name_column=["rbc"], missing_value=0)

    # Assert


@pytest.mark.active
def test_rbc_pc_happy(data_frame_federated_kidney: DataFrameFederated):
    ...
    # Act
    data_frame_federated_kidney_fixed = preprocessing.impute_constant(
        data_frame_federated_kidney, list_name_column=["rbc", "pc"], missing_value="normal"
    )
    data_frame_kidney_fixed = list(data_frame_federated_kidney_fixed.dict_dataframe.values())[0]
    data_frame_kidney = list(data_frame_federated_kidney.dict_dataframe.values())[0]
