...
class TabularToFloat64Precompute:
    def run(reference_data_frame_source: ReferenceDataFrame) -> ReferenceDataFrame:
        """
        Convert tabular dataframe to float64 format

            :param reference_data_frame_source: reference to the dataframe being converted
            :type reference_data_frame_source: ReferenceDataFrame
            :return: Reference to float 64 dataframe
        ...
        for series_name in data_frame_source.list_series_name:
            ...
            if (
                series_source.data_model_series.type_data_level
                ...
                series = Series.from_pandas(
                    ...
                    data_frame_source.data_model_data_frame[series_name],
                    series_pandas,
                )
