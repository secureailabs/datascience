...
class QueryPrecompute:
    ...
    def run(
        ...
        :param parser: The parser to use to construct the syntax tree from the
            expression.
            The default of 'pandas' parses code slightly different than
            standard Python.
        ...
        :return: DataFrame resulting from the provided query
            expression.
        :rtype: List
        """
