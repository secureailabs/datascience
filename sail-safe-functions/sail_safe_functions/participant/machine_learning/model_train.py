...
class ModelTrain(SafeFunctionBase):
    ...
    def run(
        ...
        :type: criterion: str
        :param: type_optimizer: the optimisation method of the model
        :type: criterion: str
        ...
        criterion = ModelTrain.get_criterion(type_criterion)
        optimizer = ModelTrain.get_optimizer(model, learn_rate, type_optimizer)
    ...
    def get_criterion(criterion: str) -> torch.nn.Module:
        if criterion == "MSELoss":
            ...
            raise Exception("your loss function was not found")  # TODO type this
