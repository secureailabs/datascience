...
def _col_noise_numeric(
    column: pd.Series,
    col_resolution: float,
    scale: float,
) -> pd.Series:
    """
...
def add_noise_to_dataset(
    ...
    for column in schema["dict_column"]:
        if column == "classification":
            ...
            noised_dataset[column] = _col_noise_numeric(
            ...
            noised_dataset[schema["dict_column"][column]["name_column"]] = _col_noise_categorical(
                dataset[schema["dict_column"][column]["name_column"]],
