import pandas as pd
import torch
from sail_safe_functions.common.machine_learning.linear_regression import LinearRegression
from sail_safe_functions.common.machine_learning.logistic_regression import LogisticRegression


class ModelUtility:
    """
    A helper Library to be used on the participant side to do common operations needed by different safe functions.
    """
