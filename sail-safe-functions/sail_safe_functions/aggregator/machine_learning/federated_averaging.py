...
from sail_safe_functions.participant.machine_learning.model_average import ModelAverage
from sail_safe_functions.participant.machine_learning.model_retrieve import ModelRetrieve
from sail_safe_functions.participant.machine_learning.model_train import ModelTrain
...
def federated_averaging(
    ...
    criterion: str,  # TODO make these enum
    optimizer: str,
) -> torch.nn.Module:
    """
